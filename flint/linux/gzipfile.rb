...
connector_name_response = @call.connector("ssh")
                               ...
                               .set("path",@pat)
                               .set("command","gzip /home/stridesit/Documents/compress/AUTOMATION.docx")    #Command to be executed on target machine
                               .set("timeout",600000)          #Optional timeout in milliseconds
                               .sync
