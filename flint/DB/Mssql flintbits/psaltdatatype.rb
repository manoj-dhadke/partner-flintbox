...
@tb = @input.get("tbname")
@clm = @input.get("columnname")
@db = @input.get("dbname")
@var = "import-module sqlps ; cd sql\\WIN-IHIB1BF66A7\\sqlexpress\\databases ; invoke-sqlcmd -query \"alter table #{@tb} alter column #{@clm}\" -database \"#{@db}\""
