...
@tb = @input.get("tbname")
@db = @input.get("dbname")
@quote="\'"             # Target password
@var = "import-module sqlps ; cd sql\\WIN-IHIB1BF66A7\\sqlexpress\\databases ; invoke-sqlcmd -query \"create table #{@tb}([name] varchar(20))\" -database \"#{@db}\""
