...
@drive1=@input.get("driveletter")

# Powershell command for Disk Defragmentation.
@command = "Get-WmiObject win32_volume -filter \"driveletter=\'#{@drive1}:\'\"  | Invoke-WmiMethod -Name Defrag"
