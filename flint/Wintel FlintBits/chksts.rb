...
call_connector = @call.connector("winrm")
                               ...
                               .set("command","$srvName=\"PLA\";$servicePrior=Get-Service $srvName;$srvName + $servicePrior.status;Set-service $srvName -startuptype manual;Start-service $srvName;$serviceAfter=Get-service $srvName;\"$srvName\" + $serviceAfter.status")
