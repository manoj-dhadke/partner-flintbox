...
@service = @input.get("websitename")
@service1 = @input.get("path")
# New-Item 'IIS:\Sites\Default Web Site\DemoVirtualDir1' -type VirtualDirectory -physicalPath 
@quote="\'"
@addp= " New-Item" + instance_variable_get("@quote") iis: \ Sites \Default Web Site + instance_variable_get("@service")+ instance_variable_get("@quote") + " -type VirtualSirectory - physicalPath "  +instance_variable_get("@service1")
+ " -physicalPath " + instance_variable_get("@service1")
