...
#New-Item iis:\Sites\MySite -bindings@{protocol="http";bindingInformation=":80:MySite"}-physicalPathc:\inetpub\wwwroot\mysite 

@quote="\'"
@addp= " New-Item "  + instance_variable_get("@service") + " -bindings@{protocol="http";bindingInformation=":80:+instance_variable_get("@service")+instance_variable_get("@quote") " -physicalPath " + instance_variable_get("@service1")
