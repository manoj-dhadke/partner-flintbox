...
@service = @input.get("printername")              # Target password
@quote="\'"
@log.trace('Calling WinRM Connector...')
@addp=" Remove-printer " + instance_variable_get("@quote") + instance_variable_get("@service")+ instance_variable_get("@quote") 
