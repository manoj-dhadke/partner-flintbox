...
@service = @input.get("servername")
@quote="\'"
@addp= "[System.Reflection.Assembly]::LoadWithPartialName('Microsoft.SqlServer.SMO') | out-null;
$s = New-Object ('Microsoft.SqlServer.Management.Smo.Server')" + instance_variable_get("@quote")+ instance_variable_get("@service")+ instance_variable_get("@quote") + "$dbs=$s.Databases"
