...
call_connector = @call.connector("winrm")
                               ...
                               .set("command","$srvName=\"PLA\";$servicePrior=Get-Service $srvName;\"$srvName\" + $servicePrior.status;Stop-service $srvName;$serviceAfter=Get-service $srvName;Set-Service $srvName -startuptype disabled;\"$srvName\" + $serviceAfter.status")
