...
@service = @input.get("path")              # Target password
@quote="\'"
@log.trace('Calling WinRM Connector...')
@addp=  instance_variable_get("@quote") + "ServerA"  + instance_variable_get("@quote") + " | % { dir " + instance_variable_get("@quote") + instance_variable_get("@service")+ instance_variable_get("@quote") + " }" + " | select parent, name, size "
