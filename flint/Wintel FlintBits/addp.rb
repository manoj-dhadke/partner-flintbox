...
@service = @input.get("drivername")
@service1 = @input.get("printername")
@service2 = @input.get("port")
@service3 = @input.get("drivername1")
@quote="\'"
@services = "add-printerdriver -name " + instance_variable_get("@service")
@addp="add-printer -name "+ instance_variable_get("@quote") + instance_variable_get("@service1")+ instance_variable_get("@quote") + " -port " +instance_variable_get("@quote")+instance_variable_get("@service2")+instance_variable_get("@quote")+" -drivername " +instance_variable_get("@quote")+instance_variable_get("@service3")+instance_variable_get("@quote")
