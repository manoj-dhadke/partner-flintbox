...
@service1 = @input.get("portname")
@service2 = @input.get("printerhostaddress")
@quote="\'"
@addp="add-printerport -ComputerName " + instance_variable_get("@quote") + instance_variable_get("@service")+ instance_variable_get("@quote") + " -name " +instance_variable_get("@quote")+instance_variable_get("@service1")+instance_variable_get("@quote")+" -printerhostaddress " +instance_variable_get("@quote")+instance_variable_get("@service2")+instance_variable_get("@quote")
