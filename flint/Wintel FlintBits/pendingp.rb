...
@service = @input.get("computername")              # Target password
@quote="\'"
@log.trace('Calling WinRM Connector...')
@addp=" get-printer -ComputerName  " + instance_variable_get("@quote") + instance_variable_get("@service")+ instance_variable_get("@quote") ;" | where PrinterStatus -eq Error | fl Name,JobCount "
