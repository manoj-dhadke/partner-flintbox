...
@service = @input.get("computername")
@service3=@input.get("printername")
@service1 = @input.get("drivername")
@service2= @input.get("portname")
 #Add-Printer -ComputerName HOST7 -Name "Sales Printer" -DriverName "Dell Color Laser PCL6 Class Driver"  -PortName "172.16.11.63"
@quote="\'"

@addp="Add-PrinterDriver -ComputerName "+ instance_variable_get("@service") + " -name "  +instance_variable_get("@quote")+instance_variable_get("@service1")+instance_variable_get("@quote")+ "; Add-Printer -ComputerName " +instance_variable_get("@quote") + instance_variable_get("@service") +instance_variable_get("@quote")+ " -name " +instance_variable_get("@quote") + instance_variable_get("@service3")+instance_variable_get("@quote")+" -drivername " +instance_variable_get("@quote") + instance_variable_get("@service1")+instance_variable_get("@quote") + " -portname " +instance_variable_get("@quote") + instance_variable_get("@service2")+instance_variable_get("@quote")
