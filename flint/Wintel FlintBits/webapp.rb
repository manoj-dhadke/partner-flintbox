...
@quote="\'"
@addp= " New-Item " + instance_variable_get("quote") iis:\ Sites\ Default Web Site \ + instance_variable_get("@service") + instance_variable_get("quote") + " -physicalPath " + instance_variable_get("@service1") + "  -type Application"
